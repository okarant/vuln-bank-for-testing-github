---
name: t4494-prevent-model-theft-in-large-language-models-data-scientis
description: Besides securing your infrastructure, you can prevent Large Language Models (LLM) theft by following these recommendations: - Reinforce physical security to protect servers, data centers, and other hardware from theft or tampering.
---

# T4494: Prevent model theft in Large Language Models (Data Scientist)

**Category:** ML_DOC  
**SD Elements:** [T4494](https://cd.sdelements.com/bunits/oleg-skill-test/vuln-bank-for-testing-github-app-20260616-1404/vuln-bank-for-testing-github-20260616-1404/tasks/31909-T4494/)  
**Priority:** 7  
**Domain:** llm-security
...
- Reinforce physical security to protect servers, data centers, and other hardware from theft or tampering.

## Success Criteria

- The requirement "Prevent model theft in Large Language Models (Data Scientist)" is documented with an owner and an infrastructure/process plan.
