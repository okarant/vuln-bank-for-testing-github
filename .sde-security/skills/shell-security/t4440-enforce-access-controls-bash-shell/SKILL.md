# Enforce access controls (Bash/Shell)
...
Fix the existing security vulnerability: Enforce access controls (Bash/Shell).
...
3. Update the countermeasure status in SD Elements (Project 31905, T4440)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T4440
- Classification: CODE_FIX