# Verify best practices for data-restoring operations are followed
...
Harden infrastructure configuration: Verify best practices for data-restoring operations are followed.

## Affected Files

- `app.py` (lines: all): Verify best practices for data-restoring operations are followed
...
3. Update the countermeasure status in SD Elements (Project 31905, T2613)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T2613
- Classification: INFRA