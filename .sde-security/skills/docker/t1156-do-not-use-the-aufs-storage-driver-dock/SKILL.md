...
Harden infrastructure configuration: Do not use the aufs storage driver (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1156)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1156
- Classification: INFRA