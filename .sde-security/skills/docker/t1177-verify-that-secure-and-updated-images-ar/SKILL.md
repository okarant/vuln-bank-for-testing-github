...
Harden infrastructure configuration: Verify that secure and updated images are used (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1177)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1177
- Classification: INFRA