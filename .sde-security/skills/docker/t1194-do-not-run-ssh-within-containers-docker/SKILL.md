# Do not run SSH within containers (Docker)
...
Harden infrastructure configuration: Do not run SSH within containers (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1194)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1194
- Classification: INFRA