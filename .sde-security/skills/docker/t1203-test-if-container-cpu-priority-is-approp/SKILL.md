# Test if container CPU priority is appropriately set (Docker)
...
Harden infrastructure configuration: Test if container CPU priority is appropriately set (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1203)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1203
- Classification: INFRA