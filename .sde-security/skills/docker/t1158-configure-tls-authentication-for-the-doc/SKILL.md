...
Harden infrastructure configuration: Configure TLS authentication for the Docker daemon (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1158)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1158
- Classification: INFRA