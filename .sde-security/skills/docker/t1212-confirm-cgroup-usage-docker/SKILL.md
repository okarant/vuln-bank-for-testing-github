...
Harden infrastructure configuration: Confirm cgroup usage (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1212)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1212
- Classification: INFRA