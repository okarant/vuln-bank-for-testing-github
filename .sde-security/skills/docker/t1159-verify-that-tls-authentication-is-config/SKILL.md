# Verify that TLS authentication is configured for the Docker daemon (Docker)
...
Harden infrastructure configuration: Verify that TLS authentication is configured for the Docker daemon (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1159)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1159
- Classification: INFRA