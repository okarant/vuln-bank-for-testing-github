...
Harden infrastructure configuration: Configure seccomp profile (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1210)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1210
- Classification: INFRA