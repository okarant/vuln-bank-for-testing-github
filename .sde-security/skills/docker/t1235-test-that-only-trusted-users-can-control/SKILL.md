# Test that only trusted users can control the Docker daemon (Docker)
...
Harden infrastructure configuration: Test that only trusted users can control the Docker daemon (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T1235)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T1235
- Classification: INFRA