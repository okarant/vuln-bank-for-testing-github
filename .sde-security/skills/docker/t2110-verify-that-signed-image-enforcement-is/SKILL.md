# Verify that signed image enforcement is enabled (Docker)
...
Harden infrastructure configuration: Verify that signed image enforcement is enabled (Docker).
...
3. Update the countermeasure status in SD Elements (Project 31905, T2110)

## References

- SD Elements Project: 31905
- Countermeasure: T31905-T2110
- Classification: INFRA